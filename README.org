...
+ When a site has multiple boreholes (multiple similarly named folders) additional data (either as data files on disk, or information in the README.org file) may be available in the first (alphabetically) folder.
...
#+INCLUDE: mcdowell_2021_14n/README.org :minlevel 2
#+INCLUDE: mcdowell_2021_14sa/README.org :minlevel 2
#+INCLUDE: mcdowell_2021_14sb/README.org :minlevel 2
#+INCLUDE: mcdowell_2021_14w/README.org :minlevel 2
#+INCLUDE: mcdowell_2021_15ca/README.org :minlevel 2
#+INCLUDE: mcdowell_2021_15cb/README.org :minlevel 2
#+INCLUDE: mcdowell_2021_15e/README.org :minlevel 2
#+INCLUDE: mcdowell_2021_15n/README.org :minlevel 2
#+INCLUDE: mcdowell_2021_15s/README.org :minlevel 2
#+INCLUDE: meighen/README.org :minlevel 2
...
#+RESULTS: sheet2csv
#+begin_example
Index(['Agassiz77', 'Agassiz79a', 'Agassiz79b', 'Agassiz84', 'CampCentury', 'CampIII_78b',
       'CampVI', 'StationCentrale', 'Devon98', 'Devon72', 'Devon73', 'Store_S30', 'DYE-3',
       'FladeIsblink06', 'FOXX1', 'FOXX2', 'GISP2', 'GRIP', 'GULL', 'Isunnguata_M1-10',
       'Isunnguata_M2-10B', 'Isunnguata_13km-10', 'Isunnguata_27km-11A', 'Isunnguata_27km-11B',
       'Isunnguata_27km-11C', 'Isunnguata_27km-12A', 'Isunnguata_27km-12B', 'Isunnguata_27km-12C',
       'Isunnguata_46km-11A', 'Isunnguata_46km-11B', 'HansTausen_Dome', 'HansTausen_Hare',
       'Isunnguata_33km_14N', 'Isunnguata_33km_14SA', 'Isunnguata_33km_14SB',
       'Isunnguata_33km_14W', 'Isunnguata_33km_15CA', 'Isunnguata_33km_15CB',
       'Isunnguata_33km_15E', 'Isunnguata_33km_15N', 'Isunnguata_33km_15S', 'Isua_10', 'Isua_11',
       'Isua_12', 'Isua_13', 'Isua_14', 'Jakobshavn89A', 'Jakobshavn89B', 'Jakobshavn89C',
       'Jakobshavn95D', 'Store_R30_BH19c', 'Meighen67', 'NEEM', 'NGRIP', 'Penny96',
       'PrinceWales05', 'Renland88', 'SiteII', 'TD1_88', 'TD2_88', 'TD3_88', 'TD4_91a', 'TD4_91b',
       'TD5_90', 'TD5_91', 'Tuto_D-11'],
...
+ Combine each =<site>/data.csv= into a single CSV file for all sites
+ Use relative temperature scale, 0 to 1, with 101 steps [0.00, 0.01, 0.02, ..., 0.99, 1.00]
...
df_surf.index.name = "depth [m]"
df_surf.dropna(how='all').to_csv("temperature.csv", float_format='%.4f')
...
** NOTDONE meta.bsv from spreadsheet

+ We use the Google Sheet spreadsheet to generate the individual BSV files for each borehole
+ https://docs.google.com/spreadsheets/d/1QNqnjO7Gocl29Y7X693rCRRZI4dTSq0i58YghWeHy2Q/edit#gid=765194309
...
** NOTDONE overview.bsv from meta.bsvs
...
** NOTDONE Combine all temperature profiles
...
# biber <texfile><.NOEXT> --output_format bibtex -O library.bib
